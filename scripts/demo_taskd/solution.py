...
class AlgSolution:
    ...
    def __init__(self):
        ...
        high_level_policy_path = os.path.dirname(os.path.abspath(__file__)) + '/policy_high.pt'
        low_level_policy_path = os.path.dirname(os.path.abspath(__file__)) + '/policy_low.pt'
    ...
    def predicts(self, obs, current_score):
        ...
        with torch.inference_mode():
            ...
            velocity_commands = self.high_level_policy(high_level_obs).to(device=self.device, dtype=torch.float32)*1.0
