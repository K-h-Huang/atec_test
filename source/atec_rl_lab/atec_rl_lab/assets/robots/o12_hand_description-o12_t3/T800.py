...
T800_URDF_PATH = os.path.join(LEGGED_LAB_ROOT_DIR, "assets", "t800", "urdf", "serial_t800.urdf")
# T800_URDF_PATH = "/home/zjkj/ukrl/unitree_rl_lab/unitree_model/serial_t800_lab/serial_t800_lab.usd"
T800_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        joint_drive=sim_utils.UrdfConverterCfg.JointDriveCfg(
            gains=sim_utils.UrdfConverterCfg.JointDriveCfg.PDGainsCfg(stiffness=10, damping=0.1)
        ),
    ),

    # spawn=sim_utils.UsdFileCfg(
    #     usd_path=T800_URDF_PATH,
    #     activate_contact_sensors=True,
    #     rigid_props=sim_utils.RigidBodyPropertiesCfg(
    #         disable_gravity=False,
    #         retain_accelerations=False,
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 1.1),
        joint_pos={
            # "J00_HIP_PITCH_L": -0.57 ,#DEFAULT_Q_HIP_PITCH,
            # "J01_HIP_ROLL_L": 0.17, #DEFAULT_Q_HIP_ROLL,
            # "J02_HIP_YAW_L": 0.14,#DEFAULT_Q_HIP_YAW,
            # "J03_KNEE_PITCH_L": 1.29,#DEFAULT_Q_KNEE_PITCH,
            # "J04_ANKLE_PITCH_L": -0.68,#DEFAULT_Q_ANKLE_PITCH,
            # "J05_ANKLE_ROLL_L": 0.0,#DEFAULT_Q_ANKLE_ROLL,
            # "J06_HIP_PITCH_R": -0.57 ,#DEFAULT_Q_HIP_PITCH,
            # "J07_HIP_ROLL_R": -0.14, #DEFAULT_Q_HIP_ROLL,
            # "J08_HIP_YAW_R": 0.14,#DEFAULT_Q_HIP_YAW,
            # "J09_KNEE_PITCH_R": 1.29,#DEFAULT_Q_KNEE_PITCH,
            # "J10_ANKLE_PITCH_R": -0.68,
            # "J11_ANKLE_ROLL_R": 0.0,
            # "J12_TORSO_YAW": DEFAULT_Q_TORSO_YAW,
            # "J13_SHOULDER_PITCH_L": -1.72, # DEFAULT_Q_SHOULDER_PITCH,
            # "J14_SHOULDER_ROLL_L": 0.0, #DEFAULT_Q_SHOULDER_ROLL_L,
            # "J15_SHOULDER_YAW_L": -0.6, #DEFAULT_Q_SHOULDER_YAW,
            # "J16_ELBOW_PITCH_L": -0.94 ,#DEFAULT_Q_ELBOW_PITCH,
            # "J17_ELBOW_YAW_L": -0.90, # DEFAULT_Q_ELBOW_YAW,
            # "J20_SHOULDER_PITCH_R": -1.4,#  DEFAULT_Q_SHOULDER_PITCH,
            # "J21_SHOULDER_ROLL_R": -0.45,# DEFAULT_Q_SHOULDER_ROLL_R,
            # "J22_SHOULDER_YAW_R": 0.66,#DEFAULT_Q_SHOULDER_YAW,
            # "J23_ELBOW_PITCH_R": -1.5, # DEFAULT_Q_ELBOW_PITCH,
            # "J24_ELBOW_YAW_R": -0.46, #DEFAULT_Q_ELBOW_YAW,
            # "J27_HEAD_PITCH": DEFAULT_Q_HEAD_PITCH,
            # "J28_HEAD_YAW": DEFAULT_Q_HEAD_YAW,
            "J00_HIP_PITCH_L": -0.2,#-0.43 ,#DEFAULT_Q_HIP_PITCH,
            "J01_HIP_ROLL_L": 0.23,#0.39, #DEFAULT_Q_HIP_ROLL,
            "J02_HIP_YAW_L": 0.29, #0.15,#DEFAULT_Q_HIP_YAW,
            "J03_KNEE_PITCH_L": 0.34,#0.78,#DEFAULT_Q_KNEE_PITCH,
            "J04_ANKLE_PITCH_L": -0.14,#-0.44,#DEFAULT_Q_ANKLE_PITCH,
            "J05_ANKLE_ROLL_L": -0.12, #-0.25,#DEFAULT_Q_ANKLE_ROLL,
            "J06_HIP_PITCH_R": -0.44 ,#DEFAULT_Q_HIP_PITCH,
            "J07_HIP_ROLL_R": -0.18,#-0.39, #DEFAULT_Q_HIP_ROLL,
            "J08_HIP_YAW_R": -0.12,#-0.15,#DEFAULT_Q_HIP_YAW,
            "J09_KNEE_PITCH_R": 0.39,# 0.77,#DEFAULT_Q_KNEE_PITCH,
            "J10_ANKLE_PITCH_R": -0.07,#-0.49,
            "J11_ANKLE_ROLL_R": 0.14,#0.34,
            "J12_TORSO_YAW": 0.0,
            "J13_SHOULDER_PITCH_L": -0.47, # DEFAULT_Q_SHOULDER_PITCH,
            "J14_SHOULDER_ROLL_L": 0.3, #DEFAULT_Q_SHOULDER_ROLL_L,
            "J15_SHOULDER_YAW_L": -0.39, #DEFAULT_Q_SHOULDER_YAW,
            "J16_ELBOW_PITCH_L": -1.70 ,#DEFAULT_Q_ELBOW_PITCH,
            "J17_ELBOW_YAW_L": 0.63, # DEFAULT_Q_ELBOW_YAW,
            "J20_SHOULDER_PITCH_R": -0.72,#  DEFAULT_Q_SHOULDER_PITCH,
            "J21_SHOULDER_ROLL_R": -0.26,# DEFAULT_Q_SHOULDER_ROLL_R,
            "J22_SHOULDER_YAW_R": 0.57,#DEFAULT_Q_SHOULDER_YAW,
            "J23_ELBOW_PITCH_R": -1.82, # DEFAULT_Q_ELBOW_PITCH,
            "J24_ELBOW_YAW_R": -0.46, #DEFAULT_Q_ELBOW_YAW,
            "J27_HEAD_PITCH": DEFAULT_Q_HEAD_PITCH,
            "J28_HEAD_YAW": DEFAULT_Q_HEAD_YAW,
        },
...
'''
'J00_HIP_PITCH_L', 'J06_HIP_PITCH_R', 'J12_TORSO_YAW', 'J01_HIP_ROLL_L', 'J07_HIP_ROLL_R', 'J13_SHOULDER_PITCH_L', 'J18_SHOULDER_PITCH_R', 'J23_HEAD_PITCH', 'J02_HIP_YAW_L', 'J08_HIP_YAW_R', 'J14_SHOULDER_ROLL_L', 'J19_SHOULDER_ROLL_R', 'J24_HEAD_YAW', 'J03_KNEE_PITCH_L', 'J09_KNEE_PITCH_R', 'J15_SHOULDER_YAW_L', 'J20_SHOULDER_YAW_R', 'J04_ANKLE_PITCH_L', 'J10_ANKLE_PITCH_R', 'J16_ELBOW_PITCH_L', 'J21_ELBOW_PITCH_R', 'J05_ANKLE_ROLL_L', 'J11_ANKLE_ROLL_R', 'J17_ELBOW_YAW_L', 'J22_ELBOW_YAW_R'
'''
