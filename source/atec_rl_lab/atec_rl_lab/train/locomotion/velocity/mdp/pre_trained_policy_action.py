...
class PreTrainedPolicyAction(ActionTerm):
    ...
    def __init__(self, cfg: PreTrainedPolicyActionCfg, env: ManagerBasedRLEnv) -> None:
        ...
        print(f"low_level_actions: {self._low_level_action_term.action_dim}","222222222222222222222")
        def last_action():
        ...
        cfg.low_level_observations.velocity_commands.func = lambda dummy_env: self._raw_actions[:,:cfg.low_level_decimation]
        cfg.low_level_observations.velocity_commands.params = dict()
        # cfg.low_level_observations.joint_pos.params["asset_cfg"].joint_names = self.robot.cfg.leg_joint_names
        # cfg.low_level_observations.joint_vel.params["asset_cfg"].joint_names = self.robot.cfg.leg_joint_names
    ...
    def apply_actions(self):
        if self._counter % self.cfg.low_level_decimation == 0:
            ...
            # print(f"low_level_obs: {low_level_obs.shape}")
